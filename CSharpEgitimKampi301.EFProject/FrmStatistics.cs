...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblTurkiyeCapacityAvg.Text = db.Location.Where(x => x.Country == "Türkiye").Average(y => y.Capacity)?.ToString("0");
            ...
            var guideIdByNameMetinYazar=db.Guide.Where(x=>x.GuideName=="Metin"&&x.GuideSurname=="Yazar").Select(y=>y.GuideId).FirstOrDefault();
            lblMtnYzrLocationCount.Text=db.Location.Where(x=>x.GuideId==guideIdByNameMetinYazar).Count().ToString();
        }
    }
}
